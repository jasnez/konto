...
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-05-04 | 1.2     | **Faza 3 — finansijska inteligencija.** Nove tabele: `budgets` (00053), `recurring_transactions` (00056), `ignored_recurring_candidates` (00057), `goals` (00058), `insights` (00059). Onboarding wizard sa per-step jsonb persistencijom (00060). RPC funkcije za period spent. Nightly cron `/api/cron/insights-nightly` za 6 detektora (anomalije, prilike za uštedu, prijetnja budžetu, neaktivne pretplate). UI: `/budzeti`, `/pretplate`, `/ciljevi`, `/uvidi`, dashboard widgeti za sve. |
