-- 00003: system category for account opening balance (seed + backfill for existing users).
-- This version (20260422200000) matches the migration already recorded on the remote database.
