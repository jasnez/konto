-- =============================================================================
-- Dashboard: exclude "Početno stanje" (category slug opening_balance) from
-- get_monthly_summary cash-flow aggregates (income, expense, net, avg daily).
-- Only affects RPC tx CTE; account balances and liability totals unchanged.
-- =============================================================================
