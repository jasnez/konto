-- =============================================================================
-- Dashboard: add total_liabilities to get_monthly_summary
-- Sum of |balance| in base currency for loan + credit_card accounts with
-- negative balance (independent of include_in_net_worth).
-- =============================================================================
