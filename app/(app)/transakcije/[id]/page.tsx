...
export default async function TransactionDetailPage({ params }: PageProps) {
  ...
  const [{ data: tx, error: txError }, { data: categories, error: categoriesError }] =
    await Promise.all([
      supabase
        .from('transactions')
        .select(
  ...
  return <TransactionDetailClient tx={txView} categories={categories} />;
}
